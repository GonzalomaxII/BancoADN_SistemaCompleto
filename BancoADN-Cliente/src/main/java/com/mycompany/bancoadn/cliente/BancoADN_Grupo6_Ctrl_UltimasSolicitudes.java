...
/**
 * Controlador de Pant_UltimasSolicitudes.
 *
 * Protocolo socket:
 *   → "UltSol"
 *   ← líneas hasta "FINISH":
 ...
 *
 * estado == 1 → Aceptada  (verde)
 * estado == 2 → Rechazada (rojo)
 */
public class BancoADN_Grupo6_Ctrl_UltimasSolicitudes {
    ...
    public BancoADN_Grupo6_Ctrl_UltimasSolicitudes(BancoADN_Grupo6_Pant_UltimasSolicitudes vista, ClienteSocket clienteSocket) {
        this.vista         = vista;
