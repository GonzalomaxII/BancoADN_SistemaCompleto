...
/**
 * Ventana para que el administrador modifique un perfil directamente,
 * sin pasar por el flujo de solicitudes.
 *
 * Diseño idéntico a Pant_SolicitarPerfil (700x600, misma estructura).
 *
 * Protocolo socket:
