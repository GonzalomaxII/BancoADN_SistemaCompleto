...
/**
 * Ventana que muestra las últimas 10 solicitudes resueltas (estado != 0),
 * ordenadas por fechaResolución DESC.
 *
 * Protocolo socket:
 *   → "UltSol"
 *   ← líneas hasta "FINISH":
...
public class BancoADN_Grupo6_Pant_UltimasSolicitudes extends JFrame {
    ...
    /**
     * Agrega una fila de solicitud resuelta.
     *
     * @param idSolicitud    ID de la solicitud
     * @param mail           Email del solicitante
     * @param fechaCreacion  Fecha de creación
     * @param fechaResolucion Fecha de resolución (la más reciente)
     * @param tipo           Tipo: registrar / modificar / baja / restaurar
     * @param estadoTexto    "Aceptada" o "Rechazada"
     * @param estadoColor    Color para el badge de estado
     * @param lineaExtra     Descripción o mail de usuario, según el tipo
     */
