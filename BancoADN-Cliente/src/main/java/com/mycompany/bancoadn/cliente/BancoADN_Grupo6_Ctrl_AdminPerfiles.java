...
/**
 * Controlador de Pant_AdminPerfiles.
 *
 * ── PROTOCOLO SOCKET ──────────────────────────────────────────────────────────
 *
 *   LISTAR TODOS  → "BuscarPerfilesAdmin - NULL - NULL"
 *   LISTAR NOMBRE → "BuscarPerfilesAdmin - NULL - <nombre>"
 *   LISTAR ID     → "BuscarPerfilesAdmin - <id> - NULL"
 *   ← líneas hasta "FINISH":
 *      [0]idPerfil - [1]nombreCompleto - [2]códigoSecuencia
 *      - [3]descripción - [4]estado - [5]fechaMuestra - [6]email
 *
 *   DAR DE BAJA   → "BajaAdmin - <email>"
 *                   ← "Baja completada con exito" | "No tiene perfil activo"
 *
 *   RESTAURAR     → "RestaurarAdmin - <email>"
 *                   ← "Restauracion completada con exito" | "No tiene perfil inactivo"
 */
