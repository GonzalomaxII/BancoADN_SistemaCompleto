...
/**
 * Ventana "Administrar Perfiles" del panel de administración.
 *
 * Muestra TODOS los perfiles (activos e inactivos).
 * Cada tarjeta tiene:
 *   - Nombre, ID, Código de secuencia, Fecha muestra, Email del titular
 *   - Badge ACTIVO (verde) / INACTIVO (rojo)
 *   - Botón azul  → Modificar perfil directamente
 *   - Botón rojo  → Dar de baja  (solo si ACTIVO)
 *   - Botón verde → Restaurar    (solo si INACTIVO)
 *
 * Si el buscador está vacío se muestran todos los perfiles.
 *
 * Protocolo socket:
 *   → "BuscarPerfilesAdmin - NULL - NULL"  (todos)
 *   → "BuscarPerfilesAdmin - NULL - <nombre>"
 *   → "BuscarPerfilesAdmin - <id> - NULL"
 *   ← líneas hasta "FINISH":
 *      [0]idPerfil - [1]nombreCompleto - [2]códigoSecuencia
 *      - [3]descripción - [4]estado - [5]fechaMuestra - [6]email
 */
public class BancoADN_Grupo6_Pant_AdminPerfiles extends JFrame {
    ...
    /**
     * Agrega una tarjeta de perfil al panel.
     *
     * @param idPerfil        ID del perfil
     * @param nombre          Nombre completo
     * @param codigo          Código de secuencia
     * @param descripcion     Descripción
     * @param fechaMuestra    Fecha de muestra
     * @param email           Email del titular
     * @param activo          true = ACTIVO, false = INACTIVO
     * @param onModificar     Listener botón azul "Modificar"
     * @param onBajaRestaura  Listener botón rojo "Dar de baja" / verde "Restaurar"
     */
