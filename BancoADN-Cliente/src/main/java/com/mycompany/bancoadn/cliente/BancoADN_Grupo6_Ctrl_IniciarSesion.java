...
public class BancoADN_Grupo6_Ctrl_IniciarSesion implements ActionListener {
    ...
    private Pant_IniciarSesion vista;
    private ClienteSocket clienteSocket;

    public BancoADN_Grupo6_Ctrl_IniciarSesion(Pant_IniciarSesion vista, ClienteSocket clienteSocket) {
        this.vista = vista;
    ...
    private void procesarRespuesta(String respuesta, String email) {
        if (respuesta == null) {
            ...
            case 0: // USUARIO NORMAL
                ...
                Ctrl_MenuUsuario crtlMenuUsuario = new Ctrl_MenuUsuario(menu, clienteSocket, email);
    ...
    private void abrirRegistro() {
        vista.dispose();
        Pant_CrearCuenta vistaRegistro = new Pant_CrearCuenta();
        Ctrl_CrearCuenta ctrlRegistro = new Ctrl_CrearCuenta(vistaRegistro, clienteSocket);
