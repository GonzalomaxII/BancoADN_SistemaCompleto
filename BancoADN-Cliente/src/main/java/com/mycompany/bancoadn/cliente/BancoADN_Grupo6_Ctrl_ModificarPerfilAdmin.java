...
/**
 * Controlador de Pant_ModificarPerfilAdmin.
 *
 * Ejecuta la modificación del perfil directamente mediante:
 *   → "ModificarAdmin - <email> - <nombre> - <codigo> - <descripcion> - <fecha>"
 *   ← "Modificacion completada con exito" | "No existe una cuenta con ese email"
 *
 * Al completar la modificación (o cancelar), cierra la ventana y refresca
 * el listado de perfiles en Pant_AdminPerfiles.
 */
public class BancoADN_Grupo6_Ctrl_ModificarPerfilAdmin {
    ...
    private void manejarModificar() {
        ...
        // ── Enviar al servidor ────────────────────────────
        // RequestHandler parseará:
        //   Partes[0] = "ModificarAdmin"
        //   Partes[1] = email
        //   Partes[2] = nombre
        //   Partes[3] = codigo
        //   Partes[4] = descripcion
        //   Partes[5] = fecha
