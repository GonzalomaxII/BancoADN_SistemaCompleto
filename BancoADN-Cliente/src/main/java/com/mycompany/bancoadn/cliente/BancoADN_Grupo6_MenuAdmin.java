 ...
 *   - Añadidos dos botones en la barra de título del cuerpo:
 *       · "Administrar Perfiles" (izquierda, alineado con el comienzo del scroll)
 *       · "Últimas Solicitudes"  (junto al botón Actualizar, a su izquierda)
 *
 * Cada tarjeta de solicitud muestra información diferente según el tipo:
 *
 *   registrar / modificar:
 *     Línea 1 → <mail solicitante>
 *     Línea 2 → Fecha de envío: <fecha>  |  Asunto: <tipo>
 *     Línea 3 → Descripción: <descripcion>
 *
 *   baja / restaurar:
 *     Línea 1 → <mail solicitante>
 *     Línea 2 → Fecha de envío: <fecha>  |  Asunto: <tipo>
 *     Línea 3 → Usuario: <mail solicitante>
 */
public class BancoADN_Grupo6_MenuAdmin extends JFrame {
    ...
    /** Nuevo: abre Pant_UltimasSolicitudes */
    public JButton btnUltimasSolicitudes;

    /** Nuevo: abre Pant_AdminPerfiles */
    ...
    // ── Cuerpo con nueva fila de botones ──────────────────
